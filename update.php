...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$count = mysqli_num_rows($result);
		...
		if($count == 1)
		{
		$sql="UPDATE elevi SET nume='$nume', prenume='$prenume', clasa='$clasa', unit_inv='$unitinv', localitatea='$localitate',initatal='$initiala',cnp='$cnp',sex='$sex',limbaconcurs='$lconcurs',menpost='$menpost',cazare='$cazare',observatii='$observatii',pct_jud='$pct_jud',telefon='$telefon',prof_ind='$prof_ind' WHERE id='$id'";
		$result = mysqli_query($db,$sql) or die(mysqli_error($db));
		if($result!=null)
			{
